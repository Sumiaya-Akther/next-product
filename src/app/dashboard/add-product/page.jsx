    ...
    <div className="max-w-xl mx-auto p-6 bg-white dark:bg-neutral-800 rounded-xl mt-10 shadow">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        <input
          ...
          className="p-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-indigo-500"
          required
        />
        <textarea
          name="desc"
        ...
        <input
          ...
          value={form.image}
          onChange={handleChange}
          placeholder="Image URL (/products/example.png)"
          className="p-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-indigo-500"
          required
        />
        <button
